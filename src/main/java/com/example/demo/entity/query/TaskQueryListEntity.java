...
@Entity
public class TaskQueryListEntity {
	private Integer id;
	private String name;
	private String type;
	...
	@Basic
    @Column(name = "submitStates", nullable = false)
	public Integer getSubmitStates() {
		return submitStates;
	}
	public void setSubmitStates(Integer submitStates) {
		this.submitStates = submitStates;
	}
	@Basic
    @Column(name = "submitNote", nullable = false)
